    ...
    public static class MoviesSeed
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MovieGenre>().HasData(
                new MovieGenre { MovieId = 1, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 2, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 3, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 4, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 5, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 6, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 7, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 8, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 9, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 10, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 11, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 12, GenreId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieGenre { MovieId = 13, GenreId = 1, CreateAt = DateTime.Now, Deleted = false }
            );

            modelBuilder.Entity<MovieCategory>().HasData(
                new MovieCategory { MovieId = 1, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 2, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 3, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 4, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 5, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 6, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 7, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 8, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 9, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 10, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 11, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 12, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false },
                new MovieCategory { MovieId = 13, CategoryId = 1, CreateAt = DateTime.Now, Deleted = false }
            );

            modelBuilder.Entity<MovieActor>().HasData(
                new MovieActor { MovieId = 1, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 2, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 3, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 4, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 5, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 6, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 7, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 8, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 9, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 10, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 11, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 12, ActorId = 16, CreateAt = DateTime.Now, Deleted = false },
                new MovieActor { MovieId = 13, ActorId = 16, CreateAt = DateTime.Now, Deleted = false }
            );
        }
    }
